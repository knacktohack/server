...
class PineconeClient:
    ...
    def insertQuestion(questionVector):
        ...
        PineconeClient.insertData([{"question": questionVector["question"], "vector": questionVector["vector"]}])
    ...
    def createIndex(dimension=1536, metric='cosine'):
        ...
        """
        PineconeClient._get_client()
        PineconeClient._client(indexName, dimension=dimension, metric=metric)
